...
scholar_qa = ScholarQA(paper_finder=paper_finder, llm_model=CLAUDE_4_SONNET) #llm_model can be any litellm model
...
mqa_pipeline = MultiStepQAPipeline(llm_model=CLAUDE_4_SONNET)

query = "Which is the 9th planet in our solar system?"

scholar_qa = ScholarQA(paper_finder=paper_finder, multi_step_pipeline=mqa_pipeline, llm_model=CLAUDE_4_SONNET)
